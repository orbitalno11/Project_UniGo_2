 ...
 */
public class FindRoad extends Fragment implements droplist{
    ...
    public static FindRoad newInstrance(){
        return new FindRoad();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_find_road, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        getActivity().setTitle("ค้นหาเส้นทาง e-Bus");
